...
const INSTITUTIONAL_LINKS = [
  { label: 'Política de Segurança', href: '/sobre' },
  { label: 'Política de Privacidade', href: '/contato' },
  { label: 'Termos de Uso', href: '/servicos' },
  { label: 'Canal de Atendimento', href: '/contato' },
];
  ...
  return (
    <footer className="footer-standard" aria-label="Rodapé do site" role="contentinfo">
      ...
      <div className="container">
        ...
        {/* Bloco Canônico: 3 Colunas (Marca/Slogan · Links · Redes) */}
        <div className="footer-canonical-grid">
          {/* Coluna 1: Slogan & Endereço */}
