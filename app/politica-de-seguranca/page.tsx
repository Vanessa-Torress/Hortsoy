...
export const metadata: Metadata = {
  ...
  description:
    'Diretrizes e práticas de segurança corporativa, proteção de dados e integridade dos processos e sistemas da Hortsoy.',
};
      ...
      <section className="section-padding">
        <div className="container" style={{ maxWidth: '900px' }}>
          <div className="content-box reveal">
            <p>
              A Hortsoy valoriza a segurança das informações compartilhadas por clientes, parceiros,
              colaboradores e usuários do site. Todas as práticas digitais e operacionais são
              conduzidas com foco na proteção, integridade e confidencialidade dos dados.
            </p>
            ...
            <ul>
              ...
              <li>
                Uso de boas práticas para evitar vazamento, alteração indevida ou uso não autorizado
                de dados.
              </li>
              <li>
                Controle interno de acesso, com restrição de privilégios por perfil e necessidade.
              </li>
            ...
            <p>
              ...
              compartilhamento indevido de informações e reportando qualquer sinal de acesso
              suspeito.
            </p>
          </div>
        </div>
