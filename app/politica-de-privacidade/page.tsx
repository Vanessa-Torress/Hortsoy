        ...
        <div className="container" style={{ maxWidth: '900px' }}>
          <div className="content-box reveal">
            <p>
              ...
              fornecedores e usuários do site. A coleta é feita apenas quando necessária para
              fornecer informações, atendimento e suporte ao relacionamento comercial.
            </p>

            <h2>Informações coletadas</h2>
            <p>
              Podem ser coletados dados como nome, e-mail, telefone, mensagem enviada por contato,
              informações de navegação e dados necessários para melhorar a experiência de uso do
              site.
            </p>

            <h2>Finalidade do uso</h2>
            <p>
              Os dados são utilizados para responder solicitações, fornecer informações sobre
              produtos e serviços, melhorar comunicação, suporte e garantir atendimento adequado e
              eficiente.
            </p>
            ...
            <p>
              ...
              pessoas autorizadas e mantidas pelo tempo mínimo necessário para as finalidades do
              atendimento.
            </p>
          </div>
        </div>
