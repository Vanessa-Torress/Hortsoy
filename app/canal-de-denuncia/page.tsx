      ...
      <section className="page-banner">
        <div className="container">
          ...
          <div className="breadcrumb">
            <Link href="/">Início</Link> / Canal de Atendimento
          </div>
        </div>
      </section>
      ...
      <section className="section-padding">
        <div className="container" style={{ maxWidth: '900px' }}>
          <div className="content-box reveal">
            ...
            <p>
              Para solicitar informações, esclarecer dúvidas ou formalizar comunicação institucional,
              utilize a página de <Link href="/contato">contato</Link> da empresa.
            </p>
