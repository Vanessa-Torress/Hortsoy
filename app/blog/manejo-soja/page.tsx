...
export const metadata: Metadata = {
  ...
  description:
    'HortSoy e Vittia realizam evento técnico na Fazenda Cantão em Piumhí/MG com foco em manejo de soja e nutrição avançada.',
  openGraph: {
    title: 'HortSoy e Vittia Realizam Evento Técnico sobre Manejo de Soja com Nutrição',
    description:
      'Encontro de campo com tecnologias de nutrição avançada e manejo de solo para alavancar a produtividade da soja.',
    images: ['/assets/img/blog-manejo-soja.jpg'],
  },
};

export default function BlogManejoSojaPage() {
  return (
    <main>
          ...
          <div className="blog-detail-grid">
            <div className="blog-main-column">
              ...
              <div className="blog-detail-featured">
                <img
                  loading="lazy"
                  src="/assets/img/blog-manejo-soja.jpg"
                  alt="HortSoy e Vittia Realizam Evento Técnico sobre Manejo de Soja com Nutrição"
              ...
              <div className="blog-detail-content-inner">
                <div className="blog-inner-img">
                  <img
                    loading="lazy"
                    src="/assets/img/blog-manejo-soja-1.jpg"
                    alt="HortSoy e Vittia – evento técnico imagem interna"
                  />
                </div>
                ...
                <p>
                  No dia 29 de janeiro de 2025, a <strong>HortSoy</strong>, em parceria com a{' '}
                  <strong>Vittia</strong>, promoveu um evento técnico na Fazenda Cantão, de Rubéns
                  Rezende, em Piumhí/MG. Com foco nas melhores práticas para o manejo de soja aliado
                  à nutrição, o encontro reuniu clientes e parceiros, proporcionando uma excelente
                  oportunidade para fortalecer conexões e explorar novas oportunidades no
                  agronegócio.
                </p>
                <div className="blog-inner-img">
                  <img
                    loading="lazy"
                    src="/assets/img/blog-manejo-soja-2.jpg"
                    alt="HortSoy e Vittia – evento técnico imagem interna"
                  />
                </div>
                <h2 className="blog-inner-heading">
                ...
                <p>
                  O principal objetivo do evento foi disseminar conhecimento relevante, compartilhar
                  boas práticas e fornecer informações estratégicas para melhorar a produtividade e
                  a eficiência no cultivo da soja.
                </p>
                <h2 className="blog-inner-heading">
                  Fortalecendo parcerias, cultivando resultados.
                </h2>
                <p>
                  A iniciativa foi um sucesso, sendo amplamente reconhecida pelos participantes, que
                  destacaram a qualidade do conteúdo apresentado e a aplicabilidade das soluções
                  discutidas. Como resultado, houve um aumento na demanda pelo portfólio de soluções
                  oferecido pela <strong>HortSoy</strong> e <strong>Vittia</strong>, reforçando o
                  compromisso de ambas as empresas com a inovação e o desenvolvimento do setor
                  agrícola.
                </p>
